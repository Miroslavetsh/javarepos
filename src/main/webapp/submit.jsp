...
<html>
  <head>
    ...
    <!-- Title -->
    <title>OOP Tutorial - Submit | by MiTo</title>
  </head>
  <body>
    ...
    <div class="page">
      <div class="container">
        ...
        <section class="intro">
          ...
          <div class="intro__row intro__row--subm">
            <div class="intro__titles">
              <h2 class="suptitle">result</h2>
          ...
          <div class="intro__row">
            ...
            <div class="intro__buttons">
              <form class="--inl" action="<%=request.getContextPath()%>" method="get">
                <button class="button button--home" type="submit">
              ...
              <form action="<%=request.getContextPath()%>/form" method="get">
                <button class="button" type="submit">to form</button>
              </form>
            </div>
          </div>
